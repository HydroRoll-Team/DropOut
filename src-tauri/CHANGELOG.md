...
- [`9d45126`](https://github.com/HydroRoll-Team/DropOut/commit/9d4512627a8fd673b91f7efdc762323991f543f2): Avoid the removed `ZGenerational` JVM option when using the ZGC preset with JDK 24 and newer. ([#219](https://github.com/HydroRoll-Team/DropOut/pull/219) by @tingfeng347)
