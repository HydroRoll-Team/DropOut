...
| Launcher Migration | Preview | Basic PCL/HMCL/MultiMC/Prism discovery and copy import |
...
- Preview imported, skipped, unsupported, and conflicting content
- Preserve launcher-specific metadata and overrides
- Add cancellation, rollback, and compatibility reports
- Keep source launcher data unchanged
