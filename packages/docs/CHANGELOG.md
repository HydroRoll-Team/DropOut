...
<!-- semifold:release version=0.1.0-rc.2 -->
## v0.1.0-rc.2

### Chores

- [`333d532`](https://github.com/HydroRoll-Team/DropOut/commit/333d532c0e7e390f46ce32de85e5bc8f645a9e43): Replace the temporary Rolldown Vite facade with Vite 8's built-in Rolldown pipeline, remove obsolete pnpm overrides, and roll workspace dependencies to their latest releases. ([#218](https://github.com/HydroRoll-Team/DropOut/pull/218) by @fu050409)
...
- [`7195bc2`](https://github.com/HydroRoll-Team/DropOut/commit/7195bc21d7226b015b448136347e107480affd5d): Publish bilingual Alpha 7 release notes and align installation, navigation, feature, and migration guidance with shipped behavior. ([#183](https://github.com/HydroRoll-Team/DropOut/pull/183) by @HsiangNianian)

## v0.1.0-alpha.2

### Chores

- [`0092dbc`](https://github.com/HydroRoll-Team/DropOut/commit/0092dbcc856e47e0cf2bd438da42220b3de9b6a5): sync package version with root
